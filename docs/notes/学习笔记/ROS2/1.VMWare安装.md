...
实际VMWare 在NAT模式下分配的子网网段可能会有不同，这里是192.168.11.0;
...
- `192.168.11.0`是VMware WorkStation的NAT模式子网网段，网关设置为同一网段即可转发流量。
- `233.5.5.5`是阿里云的DNS
...
![2025-02-25_05-15-20.webp](/src/2025-02-25_05-15-20.webp)

关于小海龟中蕴藏的ROS奥义，我们在后续教程中将持续探索。

至此，感谢您，ROS2在VMware安装成功。

...
![2025-04-24_02-01-33.png](../../../.vuepress/public/src/2025-04-24_02-01-33.png)
:::
...
例如上面的version是5.4.0
```shell
docker commit sharelatex sharelatex/sharelatex:5.4.0-with-texlive-full
echo 5.4.0-with-texlive-full > config/version
```
...
```shell
docker commit sharelatex sharelatex/sharelatex:[version]-with-texlive-full-and-chinese-support
echo [version]-with-texlive-full-and-chinese-support > config/version
```
...
```shell
docker commit sharelatex sharelatex/sharelatex:[version]-with-texlive-xelatex-full-and-chinese-support
echo [version]-with-texlive-xelatex-full-and-chinese-support > config/version
```

例如，按照 项目相关规范中[项目命名规范-软件开发版本规范](/project-docs/standards/name-project/#软件开发版本规范)，容器镜像应该命名为：

```shell
docker commit sharelatex sharelatex/sharelatex:V5.4.0.20250424-with-texlive-xelatex-full-and-chinese-support
echo V5.4.0.20250424-with-texlive-xelatex-full-and-chinese-support > config/version
```
